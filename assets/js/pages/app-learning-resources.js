...
export const learningTools = [
  ...
  resource("classroom-math", "Math Foundations Lab", "math", "lessons/mathematics/math-foundations-lab.html", "Practice math with ClassroomOS activities.", "Write down the activity and your solution, or save a screenshot. Return through this launchpad.", "lessons/mathematics/math-foundations-lab.html", allGrades),
  resource("classroom-guitar", "Guitar Chords", "music", "lessons/technical-elements/guitar-chords.html", "Explore chords with the classroom guitar lesson.", "Keep your chord sequence in project notes and reopen the lesson next time.", "lessons/technical-elements/guitar-chords.html", allGrades),
